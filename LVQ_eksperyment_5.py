...
for epoch in range[10, 50, 100, 500, 1000, 2000]:
    W = lvqTraining(data, target, lr=0.0001, max_epoch=epoch, err_goal=1e-10)
    predicted = []
    for sample in data:
...
# Wykres
plt.plot(epoch_values, PK_values)
plt.xlabel('Epochs')
plt.ylabel('Classification Accuracy (PK)')
plt.title('Epochs vs Classification Accuracy')
plt.show()
